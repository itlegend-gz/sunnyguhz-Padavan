...
#define EVM_RESTART_MINIEAP             (1ULL << 51)	
#define EVM_RESTART_ADBYBY		    (1ULL << 52)
#define EVM_RESTART_ALIDDNS		    (1ULL << 53)
#define EVM_RESTART_SMARTDNS	    (1ULL << 54)
#define EVM_RESTART_FRP	    (1ULL << 55)
#define EVM_RESTART_KOOLPROXY		    (1ULL << 56)
#define EVM_RESTART_CADDY		    (1ULL << 57)
#define EVM_RESTART_ADGUARDHOME		    (1ULL << 58)
#define EVM_RESTART_WYY		    (1ULL << 59)
#define EVM_RESTART_ZEROTIER		    (1ULL << 60)
